   ...
   private Administrator obtenerAdministrator(HttpServletRequest request)
    {
        ...
        Administrator.SetName(Utilidad.getParameter(request, "nombre", ""));
    ...
    protected void doGetRequestIndex(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            Administrator Administrator = new Administrator();
            Administrator.setTop_aux(10);
            ArrayList<Administrator> administrator = AdministratorDAL.buscar(Administrator);
            request.setAttribute("administrator", administrator);
            request.setAttribute("top_aux", administrator.getTop_aux());
