 ...
 * @author MINEDUCYT
 */
public class FrmMetodosPago extends javax.swing.JFrame {
DefaultTableModel modelo= new DefaultTableModel(){
    ...
    private void Buscar() {
       ...
       modelo.addColumn("Nombre");
        ...
        try {
            ArrayList<PaymentMethod> payments = PaymentMethodDAL.obtenerPorName(txtNombre.getText());
            for(int i=0; i<payments.size();i++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMetodosPago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMetodosPago().setVisible(true);
            }
        });
    }
